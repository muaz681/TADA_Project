<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TADADetailsSupApprv.aspx.cs" Inherits="UI.HR.TADA.TADADetailsSupApprv" %>
...
<head runat="server">
    ...
    <script>
        ...
        function Viewdetails(id, type) {
            window.open('TADADetails.aspx?&ID=' + id, '', 'height=375, width=930, scrollbars=yes, left=250, top=200, resizable=no, title=Preview');
        }
    </script>
    <style>
        body {
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>TA & DA Supervisor Approve</h3>
                        </div>
                            ...
                            <asp:GridView ID="dgvlist" runat="server" AutoGenerateColumns="False" Font-Size="12px" ShowFooter="True" CellPadding="3" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Left" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" CssClass="auto-style5" Width="100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="estAmount" class="form-control" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SupApprovedAmount","{0:0}") %>'></asp:Label>
                                        </ItemTemplate>
