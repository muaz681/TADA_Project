<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TADAAdminApprove.aspx.cs" Inherits="UI.HR.TADA.TADAAdminApprove" %>
                    ...
                    <div class="card">
                        <div class="card-body first_card_body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">HR End Complete</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending-tab-pane" type="button" role="tab" aria-controls="pending-tab-pane" aria-selected="false">HR End Pending</button>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h3>TA & DA Advance Approve By Admin</h3>
                                                </div>
                                        ...
                                        <asp:GridView ID="dgvlist" runat="server" AutoGenerateColumns="False" Font-Size="12px" ShowFooter="True" CellPadding="3" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Left" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" CssClass="auto-style5" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Start Date" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="strtDate" Font-Size="11px" runat="server" Text='<%# Bind("startDate", "{0:dd MMMM yyyy}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="End Date" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="enDate" Font-Size="11px" runat="server" Text='<%# Bind("endDate", "{0:dd MMMM yyyy}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Start Location" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="strtLocation" Font-Size="11px" runat="server" Text='<%# Bind("JourneyStartLocation") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Destination" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="destination" runat="server" Font-Size="11px" Text='<%# Bind("JourneyDestination") %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="center" />
                                                </asp:TemplateField>
