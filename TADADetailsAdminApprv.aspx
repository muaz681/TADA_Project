<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TADADetailsAdminApprv.aspx.cs" Inherits="UI.HR.TADA.TADADetailsAdminApprv" %>
                            ...
                            <asp:GridView ID="dgvlist" runat="server" AutoGenerateColumns="False" Font-Size="12px" ShowFooter="True" CellPadding="3" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Left" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" CssClass="auto-style5" Width="100%">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Amount" SortExpression="srId" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="estAmount" class="form-control" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "HRApprovedAmount","{0:0}") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action" SortExpression="intId">
                                        <ItemTemplate>
                                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic mixed styles example">
                                                <asp:Button ID="btnEdit" runat="server" class="btn btn-sm btn-primary" Text="Edit" OnClick="editBtnClick" CommandArgument='<%# Eval("TadaID") %>' />
                                            </div>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
